...
dfE.icon = "__MF_Base__/graphics/items/DimensionalFurnace.png"
dfE.icon_size = 32
...
dfI.icon = "__MF_Base__/graphics/items/DimensionalFurnace.png"
dfI.icon_size = 32
dfI.place_result = "DimensionalFurnace"
dfI.subgroup = "MFStructure"
dfI.order = "b"
dfI.stack_size = 20
data:extend{dfI}
...
dfT.type = "technology"
dfT.icon = "__MF_Base__/graphics/items/DimensionalFurnace.png"
dfT.icon_size = 32
dfT.unit = {
	count=150,
	time=2,
